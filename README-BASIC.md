...
V2Ray Basic 是一个简化的代理服务器部署方案，使用 WebSocket 传输协议，通过 Nginx 反向代理提供服务。适用于快速测试、学习V2Ray或在受信任的网络环境中使用。
...
# 或者
curl -O https://raw.githubusercontent.com/alleninnz/v2ray/main/deploy-v2ray-basic.sh
```
...
# 查看 V2Ray 日志
cd /opt/v2ray-basic && docker-compose logs -f v2ray

# 查看 Nginx 日志
cd /opt/v2ray-basic && docker-compose logs -f nginx
```
